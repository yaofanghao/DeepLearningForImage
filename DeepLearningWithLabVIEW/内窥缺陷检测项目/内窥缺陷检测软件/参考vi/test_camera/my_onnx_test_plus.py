...
def onnx_predict(img_name, onnx_, output_path):
    logging.info("load image")

    image_size = 480
    # 加载并预处理输入图像
    image = cv2.imread(img_name)
    output_image_name = img_name.rsplit("\\", 1)[-1]
    ...
    cv2.imencode('.jpg', mix)[1].tofile(output_path_all)
...
# img_name = "1.jpg"
# img_name2 = "2.jpg"
# img_name = "C:\\Users\\Rainy\\Desktop\\test_camera\\1.jpg"
...
# onnx_predict(img_name=img_name, onnx_=onnx_, output_path=output_path)
