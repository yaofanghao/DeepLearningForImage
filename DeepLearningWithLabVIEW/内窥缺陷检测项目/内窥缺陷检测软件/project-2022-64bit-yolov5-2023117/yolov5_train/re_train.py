...
if __name__ == "__main__":
    ...
    Init_Epoch          = sys.argv[6]
    Freeze_Epoch        = sys.argv[7]
    Freeze_batch_size   = sys.argv[8]
    #------------------------------------------------------------------#
    #   解冻阶段训练参数
    ...
    UnFreeze_Epoch = sys.argv[9]
    Unfreeze_batch_size = sys.argv[10]
    ...
    #------------------------------------------------------------------#
    # Freeze_Train        = True
    Freeze_Train          = sys.argv[11]
    Unfreeze_batch_size   = sys.argv[12]
    ...
    # 生成文件夹名称
    folder_name = current_time + sys.argv[2]
    # 构建完整的路径
