...
if __name__ == "__main__":
    ...
    mosaic              =sys.argv[4].lower() == 'true'
    mixup               =sys.argv[5].lower() == 'true'
    #------------------------------------------------------------------#
    ...
    Init_Epoch          = int(sys.argv[6])
    Freeze_Epoch        = int(sys.argv[7])
    Freeze_batch_size   = int(sys.argv[8])
    #------------------------------------------------------------------#
    #   解冻阶段训练参数
    ...
    UnFreeze_Epoch = int(sys.argv[9])
    Unfreeze_batch_size = int(sys.argv[10])
    ...
    #------------------------------------------------------------------#
    # Freeze_Train        = True
    Freeze_Train          = sys.argv[11].lower() == 'true'
    ...
    # # 生成文件夹名称
    # folder_name = current_time + sys.argv[2] +"模型和loss存放文件夹"
    # # 构建完整的路径
    ...
    if local_rank == 0:
        ...
        log_dir         = os.path.join(save_dir, "loss_map")
