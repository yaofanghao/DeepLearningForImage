...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes, phi, backbone='cspdarknet', pretrained=False, input_shape=[640, 640]):
        ...
        # self.feat1_cbam = CBAM(in_planes=320)
        # self.feat2_cbam = CBAM(in_planes=640)
        # self.feat3_cbam = CBAM(in_planes=1280)
        # self.P5upsample_attention = CBAM(in_planes=640)
        # self.P4upsample_attention = CBAM(in_planes=320)
    def forward(self, x):
        #  backbone
        feat1, feat2, feat3 = self.backbone(x)
        # # 加注意力
        # feat1 = self.feat1_cbam(feat1)
        # feat2 = self.feat2_cbam(feat2)
        # feat3 = self.feat3_cbam(feat3)
        ...
        # # 加注意力
        # P5_upsample=self.P5upsample_attention(P5_upsample)
        ...
        # # 加注意力
        # P4_upsample=self.P4upsample_attention(P4_upsample)
