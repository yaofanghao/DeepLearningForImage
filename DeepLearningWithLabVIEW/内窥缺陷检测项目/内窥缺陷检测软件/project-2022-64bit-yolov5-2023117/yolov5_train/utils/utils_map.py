            ...
            for idx, detection in enumerate(dr_data):
                ...
                if show_animation:
                    ...
                    if len(ground_truth_img) == 0:
                        ...
                        # image_path = "C:\\Users\Rainy\Desktop\project-2022-64bit-yolov5-2023117\yolov5_train\logs\map_out\images-optional\\14鼓波_new.jpg"

                        img = cv2.imdecode(np.fromfile(IMG_PATH + "\\" + ground_truth_img[0], dtype=np.uint8), -1)
                        img_cumulative_path = RESULTS_FILES_PATH + "/images/" + ground_truth_img[0]

                        print("test....")
                        print(img)
                        # print(os.path.join(parent_dir,IMG_PATH + "\\" + ground_truth_img[0]))
