...
class Winform(QWidget, Ui_WinForm):
    def __init__(self):
    ...
    def open(self):
        ...
        jpg = QPixmap(imgName).scaled(self.pix.size(),
                                      Qt.KeepAspectRatio,
                                      Qt.SmoothTransformation)
        # jpg = QPixmap(imgName)
        # self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, jpg.width(), jpg.height()))
        # self.box.set_image(imgName)
