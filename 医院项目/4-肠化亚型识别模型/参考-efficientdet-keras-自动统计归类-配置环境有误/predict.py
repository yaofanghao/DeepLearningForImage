        ...
        if confidence_down < 0.92:
            ...
            for img_name in tqdm(img_names):
                if img_name.lower().endswith(
                    ...
                    # 修改detect_image 的返回值
                    r_image, out_scores, out_classes, top, right, left, bottom = efficientdet.detect_image(image)
                    ...
                    if out_scores.size != 0:
                        ...
                        if flag3:
                            num1 += 1
                            r_image.save(os.path.join(all_save_path_allNEO, img_name.replace(".jpg", ".png")), quality=95,
                                         subsampling=0)
                    ...
                    # 没有识别出任何一个框
                        ...
                        r_image.save(os.path.join(dir_save_path_fail_output, img_name.replace(".jpg", ".png")), quality=95,
                                     subsampling=0)
                        fail += 1
