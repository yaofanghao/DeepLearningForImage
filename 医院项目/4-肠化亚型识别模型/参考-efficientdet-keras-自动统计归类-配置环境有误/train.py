...
from nets.efficientdet_training import focal, get_lr_scheduler, smooth_l1
from utils.anchors import get_anchors
from utils.callbacks import (ExponentDecayScheduler, LossHistory,
                             ParallelModelCheckpoint, EvalCallback)
from utils.dataloader import EfficientdetDatasets
from utils.utils import get_classes, image_sizes, show_config
...
if __name__ == "__main__":
    ...
    #---------------------------------------------------------------------#
    #   anchors_size    可用于设定先验框的大小。
    #                   默认的anchors_size大多数情况下都是通用的！
    ...
    model_body   = efficientdet([input_shape[0], input_shape[1], 3], phi, num_classes)
    if model_path != '':
        #------------------------------------------------------#
        #   载入预训练权重
        #------------------------------------------------------#
