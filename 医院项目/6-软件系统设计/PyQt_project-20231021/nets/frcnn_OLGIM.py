...
# --------------------------------------------#
class FRCNNOLGIM(object):
    #   初始化Faster-RCNN模型
    def __init__(self):
        self.model_path = 'nets/logs_OLGIM.h5'
        self.classes_path = 'nets/voc_classes_OLGIM.txt'
    ...
    def detect_image(self, image):
        ...
        results = self.bbox_util.detection_out_classifier(classifier_pred, rpn_results, image_shape,
                                                          input_shape, self.confidence)
        ...
        for i, c in list(enumerate(top_label)):
            ...
            draw.rectangle((tuple(text_origin), tuple(text_origin + label_size)), fill=self.colors[c], width=20)
