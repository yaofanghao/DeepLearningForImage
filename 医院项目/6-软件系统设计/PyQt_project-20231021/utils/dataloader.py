...
class FRCNNDatasets(keras.utils.Sequence):
    ...
    def __getitem__(self, index):
        ...
        return np.array(image_data), [np.array(classifications, dtype=np.float32),
    ...
    def assign_boxes(self, boxes):
        ...
        # ---------------------------------------------------#
        ingored_boxes = ingored_boxes.reshape(-1, self.num_anchors)
        ...
        #   4是编码后的结果，1为iou
        # ---------------------------------------------------#
        encoded_boxes = encoded_boxes.reshape(-1, self.num_anchors)
