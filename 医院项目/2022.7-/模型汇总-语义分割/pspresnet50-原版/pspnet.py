...
class Pspnet(object):
    _defaults = {
        ...
        #-------------------------------------------------------------------#
        # "model_path"        : 'logs/ep001-loss1.117-val_loss0.992.h5',

        "model_path"        : 'logs/ep100-loss0.351-val_loss0.407.h5',
    ...
    def __init__(self, **kwargs):
        ...
        if self.num_classes == 4:
            self.colors = [(255, 255, 255), (128, 0, 0), (0, 128, 0), (0, 0, 128)]

        # if self.num_classes <= 21:
        #     self.colors = [ (0, 0, 0), (255, 0, 0), (0, 255, 0), (0, 0, 255), (0, 0, 128), (128, 0, 128), (0, 128, 128),
