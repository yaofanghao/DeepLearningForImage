"""
    ...
    -*- coding: utf-8 -*-
    @Author  : yaofanghao
    @Last edit time    : 2023/4/18 11:19
    @File    : auto_predict_2class.py.py
    @Software: PyCharm 
...
def predict_2class(dir_origin):
    ...
    dir_origin_path = str("predict_result_") + str(dir_origin) + "/img_out_temp/"
    dir_save_path = "img_out"
    all_save_path_2 = str("predict_result_") + str(dir_origin) + "/" + str(dir_save_path) + "_2/"
    all_save_path_3 = str("predict_result_") + str(dir_origin) + "/" + str(dir_save_path) + "_3/"
