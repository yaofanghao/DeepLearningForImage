...
def Unet(input_shape, num_classes):
    ...
    P4 = identity_block(P5_up, 3, [256, 256, 512], stage=4, block='a')
    P4 =squeeze(P4)
    P4 = Concatenate(axis=3)([C4, P4])
    ...
    P3 = identity_block(P4_up, 3, [256, 256, 512], stage=4, block='b')
    P3 = squeeze(P3)
    P3 = Concatenate(axis=3)([C3, P3])
    ...
    P2 = identity_block(P3_up, 3, [128, 128, 256], stage=4, block='c')
    P2 = squeeze(P2)
    P2 = Concatenate(axis=3)([C2, P2])
    ...
    P1 = identity_block(P2_up, 3, [64, 64, 128], stage=4, block='d')
    P1 = squeeze(P1)
    P1 = Concatenate(axis=3)([C1, P1])
