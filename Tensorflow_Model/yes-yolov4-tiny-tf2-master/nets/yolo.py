...
def yolo_body(input_shape, anchors_mask, num_classes, phi = 0, weight_decay=5e-4):
    ...
    # 13,13,512 -> 13,13,256
    P5 = DarknetConv2D_BN_Leaky(256, (1,1), weight_decay=weight_decay)(feat2)
    # 13,13,256 -> 13,13,512 -> 13,13,255
    P5_output = DarknetConv2D_BN_Leaky(512, (3,3), weight_decay=weight_decay)(P5)
    P5_output = DarknetConv2D(len(anchors_mask[0]) * (num_classes+5), (1,1), weight_decay=weight_decay)(P5_output)
    ...
    P4_output = DarknetConv2D_BN_Leaky(256, (3,3), weight_decay=weight_decay)(P4)
